...
export default class globalPrizingPage {
        ...
        async Filllabl() {
                await this.page.click("(//p[text()='Fill'])[1]")

        }
        async ShfillBtn() {
                await this.page.click("(//div[@black='true'])[1]")
        ...
        async TextcolfillBtn() {
                await this.page.click("(//div[@black='true'])[2]")
        ...
        async InputHeadername() {
                const locator = this.page.locator("//span[text()='per event']/following::input")
                //expect(locator).toBeVisible()
                //await locator = keyboard.press("End")
                // await locator.click()
                await locator.fill("Demo Name")
                // await this.page.locator("//button[text()='Next']").click()
        }

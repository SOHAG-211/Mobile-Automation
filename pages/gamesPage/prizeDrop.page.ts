...
export default class prizeDropPage {
        ...
        async clickAnalyticsSection() {
                await this.page.frameLocator('iframe').locator('text=AutoStartGame DesignGame SettingsAdd BannerPrizingAnalyticsEditDelete >> p').nth(4).click()
...
async clickEditBtn(){
        ...
        async clickGameDeleteBtn() {
                await this.page.frameLocator('iframe').locator('text=AutoStartGame DesignGame SettingsAdd BannerPrizingAnalyticsEditDelete >> p').nth(6).click()

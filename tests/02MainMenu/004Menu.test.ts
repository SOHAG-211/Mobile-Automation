...
test("004M-005 | Varify all the functionality for show all icon", async ({ loginPage, MainMenu, languagePage, menuPage, page, }, testInfo) => {
...
test("004M-007 | Verify Upload All The Menu Home Icon", async ({ loginPage, MainMenu, functions, languagePage, menuPage, page, }, testInfo) => {
...
test("004M-008 | Verify Upload The Menu Prize Icon", async ({ loginPage, MainMenu, functions, languagePage, menuPage, page, }, testInfo) => {
...
test("004M-010 | Verify Upload The Menu Rule Icon", async ({ loginPage, MainMenu, functions, languagePage, menuPage, page, }, testInfo) => {
...
test("004M-011 | Verify Upload Menu Profile Icon", async ({ loginPage, MainMenu, functions, languagePage, menuPage, page, }, testInfo) => {
